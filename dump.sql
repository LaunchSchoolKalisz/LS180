...
--
-- Name: weather; Type: TABLE; Schema: public; Owner: marthakalisz
--
...
ALTER TABLE public.weather OWNER TO marthakalisz;

--
-- Data for Name: weather; Type: TABLE DATA; Schema: public; Owner: marthakalisz
--
